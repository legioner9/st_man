...
  
 ...
 hostname (1)   hostname  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня )   hostname  (1)   ( FreeBSD man: Команды и прикладные программы пользовательского уровня ) >>  hostname  (1)   ( Русские man: Команды и прикладные программы пользовательского уровня )   hostname  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня )   hostname  (7)   ( FreeBSD man: Макропакеты и соглашения )   hostname  (7)   ( Linux man: Макропакеты и соглашения ) 
   
 НАЗВАНИЕ 
