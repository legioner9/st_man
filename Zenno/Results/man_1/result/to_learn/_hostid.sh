...
  
 ...
 hostid (1)   hostid  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня ) >>  hostid  (1)   ( Русские man: Команды и прикладные программы пользовательского уровня )   hostid  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня ) 
   
 НАЗВАНИЕ 

hostid - выдает число-идентификатор компьютера
   
 СИНТАКСИС 
...
Выдает число-идентификатор компьютера в шестнадцатеричном виде.
