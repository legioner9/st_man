...
  
 ...
 fold (1)   fold  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня )   fold  (1)   ( FreeBSD man: Команды и прикладные программы пользовательского уровня ) >>  fold  (1)   ( Русские man: Команды и прикладные программы пользовательского уровня )   fold  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня )   fold  (1)   ( POSIX man: Команды и прикладные программы пользовательского уровня ) 
   
 ИМЯ 
...
Переносит входные строки каждого ФАЙЛА (по умолчанию работает со стандартным вводом),
выводя их на стандартный вывод
 

Обязательные аргументы, используемые для длинных опций, обязательны также и для коротких опций.
 
 -b ,  --bytes 
подсчитывать байты вместо столбцов
 -s ,  --spaces 
разрывать по пробелам
 -w ,  --width = ШИРИНА 
...
Программа написана David MacKenzie.
   
