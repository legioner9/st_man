...
  
 ...
 tac (1) >>  tac  (1)   ( Русские man: Команды и прикладные программы пользовательского уровня )   tac  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня ) 
   
 ИМЯ 
...
Печатает каждый из ФАЙЛОВ на стандартный вывод, начиная с последней строки.
Если ФАЙЛ не задан или задан как -, читает стандартный вывод.
