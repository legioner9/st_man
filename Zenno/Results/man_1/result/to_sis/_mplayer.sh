...
  
 ...
 mplayer (1) >>  mplayer  (1)   ( Русские man: Команды и прикладные программы пользовательского уровня )   mplayer  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня ) Ключ  mplayer  обнаружен в базе ключевых слов. 
   
 НАЗВАНИЕ 
