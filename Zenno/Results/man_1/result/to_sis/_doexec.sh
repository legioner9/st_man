...
  
 ...
 doexec (1) >>  doexec  (1)   ( Русские man: Команды и прикладные программы пользовательского уровня )   doexec  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня ) 
   
 НАЗВАНИЕ 
...
doexec - запускает исполняемый файл с произвольным argv[0]
 ...
 /путь/к/исполняемому/файлу   argv[0]  [ argv[1-n] ]
   
 ОПИСАНИЕ 
