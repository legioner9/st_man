...
  
 ...
 sched_setscheduler (2)   sched_setscheduler  (2)   ( FreeBSD man: Системные вызовы ) >>  sched_setscheduler  (2)   ( Русские man: Системные вызовы )   sched_setscheduler  (2)   ( Linux man: Системные вызовы )   sched_setscheduler  (3)   ( Solaris man: Библиотечные вызовы )   sched_setscheduler  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
