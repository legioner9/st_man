...
  
 ...
 lstat (2)   lstat  (2)   ( Solaris man: Системные вызовы )   lstat  (2)   ( FreeBSD man: Системные вызовы ) >>  lstat  (2)   ( Русские man: Системные вызовы )   lstat  (2)   ( Linux man: Системные вызовы )   lstat  (3)   ( Solaris man: Библиотечные вызовы )   lstat  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
