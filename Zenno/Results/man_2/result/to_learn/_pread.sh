...
  
 ...
 pread (2)   pread  (2)   ( Solaris man: Системные вызовы )   pread  (2)   ( FreeBSD man: Системные вызовы ) >>  pread  (2)   ( Русские man: Системные вызовы )   pread  (2)   ( Linux man: Системные вызовы )   pread  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
