...
  
 ...
 setpgid (2)   setpgid  (2)   ( Solaris man: Системные вызовы )   setpgid  (2)   ( FreeBSD man: Системные вызовы ) >>  setpgid  (2)   ( Русские man: Системные вызовы )   setpgid  (2)   ( Linux man: Системные вызовы )   setpgid  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
