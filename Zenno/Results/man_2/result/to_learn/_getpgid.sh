...
  
 ...
 getpgid (2)   getpgid  (2)   ( Solaris man: Системные вызовы )   getpgid  (2)   ( FreeBSD man: Системные вызовы ) >>  getpgid  (2)   ( Русские man: Системные вызовы )   getpgid  (2)   ( Linux man: Системные вызовы )   getpgid  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
