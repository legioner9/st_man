...
  
 ...
 shmat (2)   shmat  (2)   ( Solaris man: Системные вызовы )   shmat  (2)   ( FreeBSD man: Системные вызовы ) >>  shmat  (2)   ( Русские man: Системные вызовы )   shmat  (2)   ( Linux man: Системные вызовы )   shmat  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
