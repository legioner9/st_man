...
  
 ...
 getppid (2)   getppid  (2)   ( Solaris man: Системные вызовы )   getppid  (2)   ( FreeBSD man: Системные вызовы ) >>  getppid  (2)   ( Русские man: Системные вызовы )   getppid  (2)   ( Linux man: Системные вызовы )   getppid  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 ИМЯ 
