...
  
 ...
 sigsetmask (2)   sigsetmask  (2)   ( FreeBSD man: Системные вызовы ) >>  sigsetmask  (2)   ( Русские man: Системные вызовы )   sigsetmask  (2)   ( Linux man: Системные вызовы )   sigsetmask  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
