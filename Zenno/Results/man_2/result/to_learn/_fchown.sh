...
  
 ...
 fchown (2)   fchown  (2)   ( Solaris man: Системные вызовы )   fchown  (2)   ( FreeBSD man: Системные вызовы ) >>  fchown  (2)   ( Русские man: Системные вызовы )   fchown  (2)   ( Linux man: Системные вызовы )   fchown  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 ИМЯ 
