...
  
 ...
 sigaction (2)   sigaction  (2)   ( Solaris man: Системные вызовы )   sigaction  (2)   ( FreeBSD man: Системные вызовы ) >>  sigaction  (2)   ( Русские man: Системные вызовы )   sigaction  (2)   ( Linux man: Системные вызовы )   sigaction  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
