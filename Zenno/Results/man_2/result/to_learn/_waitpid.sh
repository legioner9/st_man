...
  
 ...
 waitpid (2)   waitpid  (2)   ( Solaris man: Системные вызовы )   waitpid  (2)   ( FreeBSD man: Системные вызовы ) >>  waitpid  (2)   ( Русские man: Системные вызовы )   waitpid  (2)   ( Linux man: Системные вызовы )   waitpid  (3)   ( Solaris man: Библиотечные вызовы )   waitpid  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
