...
  
 ...
 sysctl (2) >>  sysctl  (2)   ( Русские man: Системные вызовы )   sysctl  (2)   ( Linux man: Системные вызовы )   sysctl  (3)   ( FreeBSD man: Библиотечные вызовы )   sysctl  (8)   ( FreeBSD man: Команды системного администрирования )   sysctl  (8)   ( Русские man: Команды системного администрирования )   sysctl  (8)   ( Linux man: Команды системного администрирования )   sysctl  (9)   ( FreeBSD man: Ядро ) Ключ  sysctl  обнаружен в базе ключевых слов. 
   
 НАЗВАНИЕ 
