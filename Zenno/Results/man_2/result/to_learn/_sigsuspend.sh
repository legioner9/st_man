...
  
 ...
 sigsuspend (2)   sigsuspend  (2)   ( Solaris man: Системные вызовы )   sigsuspend  (2)   ( FreeBSD man: Системные вызовы ) >>  sigsuspend  (2)   ( Русские man: Системные вызовы )   sigsuspend  (2)   ( Linux man: Системные вызовы )   sigsuspend  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
