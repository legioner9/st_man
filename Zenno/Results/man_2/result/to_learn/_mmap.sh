...
  
 ...
 mmap (2)   mmap  (2)   ( Solaris man: Системные вызовы )   mmap  (2)   ( FreeBSD man: Системные вызовы ) >>  mmap  (2)   ( Русские man: Системные вызовы )   mmap  (2)   ( Linux man: Системные вызовы )   mmap  (3)   ( POSIX man: Библиотечные вызовы )   mmap  (9)   ( Solaris man: Ядро ) 
   
 НАЗВАНИЕ 
