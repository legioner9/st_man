...
  
 ...
 sigprocmask (2)   sigprocmask  (2)   ( Solaris man: Системные вызовы )   sigprocmask  (2)   ( FreeBSD man: Системные вызовы ) >>  sigprocmask  (2)   ( Русские man: Системные вызовы )   sigprocmask  (2)   ( Linux man: Системные вызовы )   sigprocmask  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
