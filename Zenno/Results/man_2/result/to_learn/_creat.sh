...
  
 ...
 creat (2)   creat  (2)   ( Solaris man: Системные вызовы )   creat  (2)   ( FreeBSD man: Системные вызовы ) >>  creat  (2)   ( Русские man: Системные вызовы )   creat  (2)   ( Linux man: Системные вызовы )   creat  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
