...
  
 ...
 wait (2)   wait  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня )   wait  (1)   ( FreeBSD man: Команды и прикладные программы пользовательского уровня )   wait  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня )   wait  (1)   ( POSIX man: Команды и прикладные программы пользовательского уровня )   wait  (2)   ( Solaris man: Системные вызовы )   wait  (2)   ( FreeBSD man: Системные вызовы ) >>  wait  (2)   ( Русские man: Системные вызовы )   wait  (2)   ( Linux man: Системные вызовы )   wait  (3)   ( Solaris man: Библиотечные вызовы )   wait  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
