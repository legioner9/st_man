...
  
 ...
 fchdir (2)   fchdir  (2)   ( Solaris man: Системные вызовы )   fchdir  (2)   ( FreeBSD man: Системные вызовы ) >>  fchdir  (2)   ( Русские man: Системные вызовы )   fchdir  (2)   ( Linux man: Системные вызовы )   fchdir  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
