...
  
 ...
 getrusage (2)   getrusage  (2)   ( FreeBSD man: Системные вызовы ) >>  getrusage  (2)   ( Русские man: Системные вызовы )   getrusage  (2)   ( Linux man: Системные вызовы )   getrusage  (3)   ( Solaris man: Библиотечные вызовы )   getrusage  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
