...
  
 ...
 break (2)   break  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня )   break  (1)   ( FreeBSD man: Команды и прикладные программы пользовательского уровня )   break  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня )   break  (1)   ( POSIX man: Команды и прикладные программы пользовательского уровня ) >>  break  (2)   ( Русские man: Системные вызовы )   break  (2)   ( Linux man: Системные вызовы ) 
   
 ИМЯ 
