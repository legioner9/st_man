...
  
 ...
 utime (2)   utime  (2)   ( Solaris man: Системные вызовы ) >>  utime  (2)   ( Русские man: Системные вызовы )   utime  (2)   ( Linux man: Системные вызовы )   utime  (3)   ( FreeBSD man: Библиотечные вызовы )   utime  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 ИМЯ 
