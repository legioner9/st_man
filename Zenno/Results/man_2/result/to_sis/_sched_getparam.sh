...
  
 ...
 sched_getparam (2)   sched_getparam  (2)   ( FreeBSD man: Системные вызовы ) >>  sched_getparam  (2)   ( Русские man: Системные вызовы )   sched_getparam  (2)   ( Linux man: Системные вызовы )   sched_getparam  (3)   ( Solaris man: Библиотечные вызовы )   sched_getparam  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
