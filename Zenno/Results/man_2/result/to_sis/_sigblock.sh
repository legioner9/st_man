...
  
 ...
 sigblock (2)   sigblock  (2)   ( FreeBSD man: Системные вызовы ) >>  sigblock  (2)   ( Русские man: Системные вызовы )   sigblock  (2)   ( Linux man: Системные вызовы )   sigblock  (3)   ( Solaris man: Библиотечные вызовы )   sigblock  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
