...
  
 ...
 recvfrom (2)   recvfrom  (2)   ( FreeBSD man: Системные вызовы ) >>  recvfrom  (2)   ( Русские man: Системные вызовы )   recvfrom  (2)   ( Linux man: Системные вызовы )   recvfrom  (3)   ( Solaris man: Библиотечные вызовы )   recvfrom  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
