...
  
 ...
 msgrcv (2)   msgrcv  (2)   ( Solaris man: Системные вызовы ) >>  msgrcv  (2)   ( Русские man: Системные вызовы )   msgrcv  (2)   ( Linux man: Системные вызовы )   msgrcv  (3)   ( FreeBSD man: Библиотечные вызовы )   msgrcv  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
