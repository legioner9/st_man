...
  
 ...
 setdomainname (2) >>  setdomainname  (2)   ( Русские man: Системные вызовы )   setdomainname  (2)   ( Linux man: Системные вызовы )   setdomainname  (3)   ( FreeBSD man: Библиотечные вызовы ) 
   
 ИМЯ 
