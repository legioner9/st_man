...
  
 ...
 send (2)   send  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня )   send  (2)   ( FreeBSD man: Системные вызовы ) >>  send  (2)   ( Русские man: Системные вызовы )   send  (2)   ( Linux man: Системные вызовы )   send  (3)   ( Solaris man: Библиотечные вызовы )   send  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
