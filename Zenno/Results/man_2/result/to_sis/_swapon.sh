...
  
 ...
 swapon (2)   swapon  (2)   ( FreeBSD man: Системные вызовы ) >>  swapon  (2)   ( Русские man: Системные вызовы )   swapon  (2)   ( Linux man: Системные вызовы )   swapon  (8)   ( FreeBSD man: Команды системного администрирования )   swapon  (8)   ( Linux man: Команды системного администрирования ) 
   
 НАЗВАНИЕ 
