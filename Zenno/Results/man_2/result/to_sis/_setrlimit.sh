...
  
 ...
 setrlimit (2)   setrlimit  (2)   ( Solaris man: Системные вызовы )   setrlimit  (2)   ( FreeBSD man: Системные вызовы ) >>  setrlimit  (2)   ( Русские man: Системные вызовы )   setrlimit  (2)   ( Linux man: Системные вызовы )   setrlimit  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
