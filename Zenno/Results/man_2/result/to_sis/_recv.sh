...
  
 ...
 recv (2)   recv  (2)   ( FreeBSD man: Системные вызовы ) >>  recv  (2)   ( Русские man: Системные вызовы )   recv  (2)   ( Linux man: Системные вызовы )   recv  (3)   ( Solaris man: Библиотечные вызовы )   recv  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
