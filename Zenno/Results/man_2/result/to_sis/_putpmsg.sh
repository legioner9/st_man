...
  
 ...
 putpmsg (2)   putpmsg  (2)   ( Solaris man: Системные вызовы ) >>  putpmsg  (2)   ( Русские man: Системные вызовы )   putpmsg  (2)   ( Linux man: Системные вызовы )   putpmsg  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 ИМЯ 
