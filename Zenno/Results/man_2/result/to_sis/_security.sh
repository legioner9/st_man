...
  
 ...
 security (2) >>  security  (2)   ( Русские man: Системные вызовы )   security  (2)   ( Linux man: Системные вызовы )   security  (7)   ( FreeBSD man: Макропакеты и соглашения ) Ключ  security  обнаружен в базе ключевых слов. 
   
 ИМЯ 
