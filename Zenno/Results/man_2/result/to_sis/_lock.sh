...
  
 ...
 lock (2)   lock  (1)   ( FreeBSD man: Команды и прикладные программы пользовательского уровня ) >>  lock  (2)   ( Русские man: Системные вызовы )   lock  (2)   ( Linux man: Системные вызовы )   lock  (7)   ( Linux man: Макропакеты и соглашения )   lock  (9)   ( FreeBSD man: Ядро ) Ключ  lock  обнаружен в базе ключевых слов. 
   
 ИМЯ 
