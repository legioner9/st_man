...
  
 ...
 sendto (2)   sendto  (2)   ( FreeBSD man: Системные вызовы ) >>  sendto  (2)   ( Русские man: Системные вызовы )   sendto  (2)   ( Linux man: Системные вызовы )   sendto  (3)   ( Solaris man: Библиотечные вызовы )   sendto  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
