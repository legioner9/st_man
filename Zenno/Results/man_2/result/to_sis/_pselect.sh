...
  
 ...
 pselect (2) >>  pselect  (2)   ( Русские man: Системные вызовы )   pselect  (2)   ( Linux man: Системные вызовы )   pselect  (3)   ( FreeBSD man: Библиотечные вызовы )   pselect  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
