...
  
 ...
 gtty (2)   gtty  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня ) >>  gtty  (2)   ( Русские man: Системные вызовы )   gtty  (2)   ( Linux man: Системные вызовы )   gtty  (3)   ( FreeBSD man: Библиотечные вызовы ) 
   
 ИМЯ 
