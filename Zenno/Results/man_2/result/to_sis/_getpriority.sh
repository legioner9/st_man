...
  
 ...
 getpriority (2)   getpriority  (2)   ( FreeBSD man: Системные вызовы ) >>  getpriority  (2)   ( Русские man: Системные вызовы )   getpriority  (2)   ( Linux man: Системные вызовы )   getpriority  (3)   ( Solaris man: Библиотечные вызовы )   getpriority  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 ИМЯ 
