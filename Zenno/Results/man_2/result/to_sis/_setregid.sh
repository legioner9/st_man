...
  
 ...
 setregid (2)   setregid  (2)   ( Solaris man: Системные вызовы )   setregid  (2)   ( FreeBSD man: Системные вызовы ) >>  setregid  (2)   ( Русские man: Системные вызовы )   setregid  (2)   ( Linux man: Системные вызовы )   setregid  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
