...
  
 ...
 getpmsg (2)   getpmsg  (2)   ( Solaris man: Системные вызовы ) >>  getpmsg  (2)   ( Русские man: Системные вызовы )   getpmsg  (2)   ( Linux man: Системные вызовы )   getpmsg  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 ИМЯ 
