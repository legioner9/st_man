...
  
 ...
 getegid (2)   getegid  (2)   ( Solaris man: Системные вызовы )   getegid  (2)   ( FreeBSD man: Системные вызовы ) >>  getegid  (2)   ( Русские man: Системные вызовы )   getegid  (2)   ( Linux man: Системные вызовы )   getegid  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
