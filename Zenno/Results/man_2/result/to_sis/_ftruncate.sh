...
  
 ...
 ftruncate (2)   ftruncate  (2)   ( FreeBSD man: Системные вызовы ) >>  ftruncate  (2)   ( Русские man: Системные вызовы )   ftruncate  (2)   ( Linux man: Системные вызовы )   ftruncate  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
