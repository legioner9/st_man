...
  
 ...
 prof (2)   prof  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня ) >>  prof  (2)   ( Русские man: Системные вызовы )   prof  (2)   ( Linux man: Системные вызовы )   prof  (5)   ( Solaris man: Форматы файлов ) 
   
 ИМЯ 
