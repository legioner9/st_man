...
  
 ...
 getpgrp (2)   getpgrp  (2)   ( Solaris man: Системные вызовы )   getpgrp  (2)   ( FreeBSD man: Системные вызовы ) >>  getpgrp  (2)   ( Русские man: Системные вызовы )   getpgrp  (2)   ( Linux man: Системные вызовы )   getpgrp  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
