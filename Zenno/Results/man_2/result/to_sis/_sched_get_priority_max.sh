...
  
 ...
 sched_get_priority_max (2)   sched_get_priority_max  (2)   ( FreeBSD man: Системные вызовы ) >>  sched_get_priority_max  (2)   ( Русские man: Системные вызовы )   sched_get_priority_max  (2)   ( Linux man: Системные вызовы )   sched_get_priority_max  (3)   ( Solaris man: Библиотечные вызовы )   sched_get_priority_max  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
