...
  
 ...
 putchar (3)   putchar  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  putchar  (3)   ( Русские man: Библиотечные вызовы )   putchar  (3)   ( Linux man: Библиотечные вызовы )   putchar  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
