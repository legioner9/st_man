...
  
 ...
 getnetbyname (3)   getnetbyname  (3)   ( Solaris man: Библиотечные вызовы )   getnetbyname  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getnetbyname  (3)   ( Русские man: Библиотечные вызовы )   getnetbyname  (3)   ( Linux man: Библиотечные вызовы )   getnetbyname  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
