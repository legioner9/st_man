...
  
 ...
 scanf (3)   scanf  (3)   ( Solaris man: Библиотечные вызовы )   scanf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  scanf  (3)   ( Русские man: Библиотечные вызовы )   scanf  (3)   ( Linux man: Библиотечные вызовы )   scanf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
