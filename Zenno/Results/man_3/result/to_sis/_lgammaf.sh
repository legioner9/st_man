...
  
 ...
 lgammaf (3)   lgammaf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  lgammaf  (3)   ( Русские man: Библиотечные вызовы )   lgammaf  (3)   ( Linux man: Библиотечные вызовы )   lgammaf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
