...
  
 ...
 stdin (3) >>  stdin  (3)   ( Русские man: Библиотечные вызовы )   stdin  (3)   ( Linux man: Библиотечные вызовы )   stdin  (3)   ( POSIX man: Библиотечные вызовы )   stdin  (4)   ( FreeBSD man: Специальные файлы /dev/* ) BSD mandoc 
Linux 2.0
