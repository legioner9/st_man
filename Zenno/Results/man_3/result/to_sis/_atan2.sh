...
  
 ...
 atan2 (3)   atan2  (3)   ( Solaris man: Библиотечные вызовы )   atan2  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  atan2  (3)   ( Русские man: Библиотечные вызовы )   atan2  (3)   ( Linux man: Библиотечные вызовы )   atan2  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
