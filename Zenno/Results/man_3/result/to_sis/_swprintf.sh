...
  
 ...
 swprintf (3)   swprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  swprintf  (3)   ( Русские man: Библиотечные вызовы )   swprintf  (3)   ( Linux man: Библиотечные вызовы )   swprintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
