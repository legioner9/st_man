...
  
 ...
 ether_ntohost (3)   ether_ntohost  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ether_ntohost  (3)   ( Русские man: Библиотечные вызовы )   ether_ntohost  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
