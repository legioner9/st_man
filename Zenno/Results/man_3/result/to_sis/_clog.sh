...
  
 ...
 clog (3)   clog  (3)   ( Solaris man: Библиотечные вызовы ) >>  clog  (3)   ( Русские man: Библиотечные вызовы )   clog  (3)   ( Linux man: Библиотечные вызовы )   clog  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
