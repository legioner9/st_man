...
  
 ...
 snprintf (3)   snprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  snprintf  (3)   ( Русские man: Библиотечные вызовы )   snprintf  (3)   ( Linux man: Библиотечные вызовы )   snprintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
