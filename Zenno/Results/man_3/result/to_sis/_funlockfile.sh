...
  
 ...
 funlockfile (3)   funlockfile  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  funlockfile  (3)   ( Русские man: Библиотечные вызовы )   funlockfile  (3)   ( Linux man: Библиотечные вызовы )   funlockfile  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
