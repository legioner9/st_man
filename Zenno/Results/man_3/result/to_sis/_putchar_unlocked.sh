...
  
 ...
 putchar_unlocked (3)   putchar_unlocked  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  putchar_unlocked  (3)   ( Русские man: Библиотечные вызовы )   putchar_unlocked  (3)   ( Linux man: Библиотечные вызовы )   putchar_unlocked  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
