...
  
 ...
 atanh (3)   atanh  (3)   ( Solaris man: Библиотечные вызовы )   atanh  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  atanh  (3)   ( Русские man: Библиотечные вызовы )   atanh  (3)   ( Linux man: Библиотечные вызовы )   atanh  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
