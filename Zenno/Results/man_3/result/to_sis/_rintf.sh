...
  
 ...
 rintf (3)   rintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  rintf  (3)   ( Русские man: Библиотечные вызовы )   rintf  (3)   ( Linux man: Библиотечные вызовы )   rintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
