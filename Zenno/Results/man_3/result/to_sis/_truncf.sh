...
  
 ...
 truncf (3)   truncf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  truncf  (3)   ( Русские man: Библиотечные вызовы )   truncf  (3)   ( Linux man: Библиотечные вызовы )   truncf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
