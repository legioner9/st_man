...
  
 ...
 cimag (3)   cimag  (3)   ( Solaris man: Библиотечные вызовы )   cimag  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  cimag  (3)   ( Русские man: Библиотечные вызовы )   cimag  (3)   ( Linux man: Библиотечные вызовы )   cimag  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
