...
  
 ...
 clnt_destroy (3)   clnt_destroy  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clnt_destroy  (3)   ( Русские man: Библиотечные вызовы )   clnt_destroy  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
