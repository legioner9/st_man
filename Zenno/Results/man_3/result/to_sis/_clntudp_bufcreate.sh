...
  
 ...
 clntudp_bufcreate (3)   clntudp_bufcreate  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clntudp_bufcreate  (3)   ( Русские man: Библиотечные вызовы )   clntudp_bufcreate  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
