...
  
 ...
 islessequal (3)   islessequal  (3)   ( Solaris man: Библиотечные вызовы )   islessequal  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  islessequal  (3)   ( Русские man: Библиотечные вызовы )   islessequal  (3)   ( Linux man: Библиотечные вызовы )   islessequal  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
