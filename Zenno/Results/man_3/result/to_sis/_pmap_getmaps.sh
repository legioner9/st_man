...
  
 ...
 pmap_getmaps (3)   pmap_getmaps  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  pmap_getmaps  (3)   ( Русские man: Библиотечные вызовы )   pmap_getmaps  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
