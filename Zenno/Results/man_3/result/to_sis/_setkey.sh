...
  
 ...
 setkey (3)   setkey  (3)   ( Solaris man: Библиотечные вызовы ) >>  setkey  (3)   ( Русские man: Библиотечные вызовы )   setkey  (3)   ( Linux man: Библиотечные вызовы )   setkey  (3)   ( POSIX man: Библиотечные вызовы )   setkey  (8)   ( FreeBSD man: Команды системного администрирования )   setkey  (8)   ( Linux man: Команды системного администрирования ) 
   
 НАЗВАНИЕ 
