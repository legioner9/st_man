...
  
 ...
 pathconf (3)   pathconf  (2)   ( Solaris man: Системные вызовы )   pathconf  (2)   ( FreeBSD man: Системные вызовы ) >>  pathconf  (3)   ( Русские man: Библиотечные вызовы )   pathconf  (3)   ( Linux man: Библиотечные вызовы )   pathconf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
