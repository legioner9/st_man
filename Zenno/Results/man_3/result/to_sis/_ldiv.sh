...
  
 ...
 ldiv (3)   ldiv  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ldiv  (3)   ( Русские man: Библиотечные вызовы )   ldiv  (3)   ( Linux man: Библиотечные вызовы )   ldiv  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
