...
  
 ...
 roundl (3)   roundl  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  roundl  (3)   ( Русские man: Библиотечные вызовы )   roundl  (3)   ( Linux man: Библиотечные вызовы )   roundl  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
