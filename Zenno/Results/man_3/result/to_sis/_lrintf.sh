...
  
 ...
 lrintf (3)   lrintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  lrintf  (3)   ( Русские man: Библиотечные вызовы )   lrintf  (3)   ( Linux man: Библиотечные вызовы )   lrintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
