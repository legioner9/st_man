...
  
 ...
 clnttcp_create (3)   clnttcp_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clnttcp_create  (3)   ( Русские man: Библиотечные вызовы )   clnttcp_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
