...
  
 ...
 setprotoent (3)   setprotoent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setprotoent  (3)   ( Русские man: Библиотечные вызовы )   setprotoent  (3)   ( Linux man: Библиотечные вызовы )   setprotoent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
