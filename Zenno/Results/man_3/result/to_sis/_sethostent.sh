...
  
 ...
 sethostent (3)   sethostent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  sethostent  (3)   ( Русские man: Библиотечные вызовы )   sethostent  (3)   ( Linux man: Библиотечные вызовы )   sethostent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
