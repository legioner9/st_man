...
  
 ...
 lroundl (3)   lroundl  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  lroundl  (3)   ( Русские man: Библиотечные вызовы )   lroundl  (3)   ( Linux man: Библиотечные вызовы )   lroundl  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
