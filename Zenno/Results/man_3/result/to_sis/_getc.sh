...
  
 ...
 getc (3)   getc  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getc  (3)   ( Русские man: Библиотечные вызовы )   getc  (3)   ( Linux man: Библиотечные вызовы )   getc  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
