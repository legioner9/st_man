...
  
 ...
 casin (3)   casin  (3)   ( Solaris man: Библиотечные вызовы ) >>  casin  (3)   ( Русские man: Библиотечные вызовы )   casin  (3)   ( Linux man: Библиотечные вызовы )   casin  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
