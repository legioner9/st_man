...
  
 ...
 exec (3)   exec  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня )   exec  (1)   ( FreeBSD man: Команды и прикладные программы пользовательского уровня )   exec  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня )   exec  (1)   ( POSIX man: Команды и прикладные программы пользовательского уровня )   exec  (2)   ( Solaris man: Системные вызовы )   exec  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  exec  (3)   ( Русские man: Библиотечные вызовы )   exec  (3)   ( Linux man: Библиотечные вызовы )   exec  (3)   ( POSIX man: Библиотечные вызовы ) Ключ  exec  обнаружен в базе ключевых слов. 
   
 НАЗВАНИЕ 
