...
  
 ...
 inet_network (3)   inet_network  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  inet_network  (3)   ( Русские man: Библиотечные вызовы )   inet_network  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
