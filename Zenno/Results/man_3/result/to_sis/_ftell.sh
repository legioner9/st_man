...
  
 ...
 ftell (3)   ftell  (3)   ( Solaris man: Библиотечные вызовы )   ftell  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ftell  (3)   ( Русские man: Библиотечные вызовы )   ftell  (3)   ( Linux man: Библиотечные вызовы )   ftell  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
