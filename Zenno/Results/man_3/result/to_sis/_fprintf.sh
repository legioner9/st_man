...
  
 ...
 fprintf (3)   fprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fprintf  (3)   ( Русские man: Библиотечные вызовы )   fprintf  (3)   ( Linux man: Библиотечные вызовы )   fprintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
