...
  
 ...
 rpc (3)   rpc  (3)   ( Solaris man: Библиотечные вызовы )   rpc  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  rpc  (3)   ( Русские man: Библиотечные вызовы )   rpc  (3)   ( Linux man: Библиотечные вызовы )   rpc  (4)   ( Solaris man: Специальные файлы /dev/* )   rpc  (5)   ( FreeBSD man: Форматы файлов )   rpc  (5)   ( Русские man: Форматы файлов )   rpc  (5)   ( Linux man: Форматы файлов ) Ключ  rpc  обнаружен в базе ключевых слов. 
   
 НАЗВАНИЕ 
