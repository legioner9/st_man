...
  
 ...
 ceill (3)   ceill  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ceill  (3)   ( Русские man: Библиотечные вызовы )   ceill  (3)   ( Linux man: Библиотечные вызовы )   ceill  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
