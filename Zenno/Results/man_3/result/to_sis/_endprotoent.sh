...
  
 ...
 endprotoent (3)   endprotoent  (3)   ( Solaris man: Библиотечные вызовы )   endprotoent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  endprotoent  (3)   ( Русские man: Библиотечные вызовы )   endprotoent  (3)   ( Linux man: Библиотечные вызовы )   endprotoent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
