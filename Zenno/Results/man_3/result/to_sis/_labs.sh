...
  
 ...
 labs (3)   labs  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  labs  (3)   ( Русские man: Библиотечные вызовы )   labs  (3)   ( Linux man: Библиотечные вызовы )   labs  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
