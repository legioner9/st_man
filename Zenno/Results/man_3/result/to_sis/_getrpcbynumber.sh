...
  
 ...
 getrpcbynumber (3)   getrpcbynumber  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getrpcbynumber  (3)   ( Русские man: Библиотечные вызовы )   getrpcbynumber  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
