...
  
 ...
 cfsetospeed (3)   cfsetospeed  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  cfsetospeed  (3)   ( Русские man: Библиотечные вызовы )   cfsetospeed  (3)   ( Linux man: Библиотечные вызовы )   cfsetospeed  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
