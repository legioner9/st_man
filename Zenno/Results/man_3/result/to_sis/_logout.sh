...
  
 ...
 logout (3)   logout  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня )   logout  (1)   ( FreeBSD man: Команды и прикладные программы пользовательского уровня )   logout  (1)   ( Linux man: Команды и прикладные программы пользовательского уровня )   logout  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  logout  (3)   ( Русские man: Библиотечные вызовы )   logout  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
