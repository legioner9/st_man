...
  
 ...
 y0 (3)   y0  (3)   ( Solaris man: Библиотечные вызовы )   y0  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  y0  (3)   ( Русские man: Библиотечные вызовы )   y0  (3)   ( Linux man: Библиотечные вызовы )   y0  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
