...
  
 ...
 setusershell (3)   setusershell  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setusershell  (3)   ( Русские man: Библиотечные вызовы )   setusershell  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
