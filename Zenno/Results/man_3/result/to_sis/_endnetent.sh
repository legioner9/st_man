...
  
 ...
 endnetent (3)   endnetent  (3)   ( Solaris man: Библиотечные вызовы )   endnetent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  endnetent  (3)   ( Русские man: Библиотечные вызовы )   endnetent  (3)   ( Linux man: Библиотечные вызовы )   endnetent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
