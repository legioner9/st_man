...
  
 ...
 pmap_getport (3)   pmap_getport  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  pmap_getport  (3)   ( Русские man: Библиотечные вызовы )   pmap_getport  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
