...
  
 ...
 feraiseexcept (3)   feraiseexcept  (3)   ( Solaris man: Библиотечные вызовы )   feraiseexcept  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  feraiseexcept  (3)   ( Русские man: Библиотечные вызовы )   feraiseexcept  (3)   ( Linux man: Библиотечные вызовы )   feraiseexcept  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
