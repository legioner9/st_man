...
  
 ...
 xdr_rejected_reply (3)   xdr_rejected_reply  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdr_rejected_reply  (3)   ( Русские man: Библиотечные вызовы )   xdr_rejected_reply  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
