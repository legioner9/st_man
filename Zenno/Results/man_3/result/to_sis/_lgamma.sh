...
  
 ...
 lgamma (3)   lgamma  (3)   ( Solaris man: Библиотечные вызовы )   lgamma  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  lgamma  (3)   ( Русские man: Библиотечные вызовы )   lgamma  (3)   ( Linux man: Библиотечные вызовы )   lgamma  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
