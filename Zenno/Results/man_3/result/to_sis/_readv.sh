...
  
 ...
 readv (3)   readv  (2)   ( Solaris man: Системные вызовы )   readv  (2)   ( FreeBSD man: Системные вызовы )   readv  (2)   ( Русские man: Системные вызовы )   readv  (2)   ( Linux man: Системные вызовы ) >>  readv  (3)   ( Русские man: Библиотечные вызовы )   readv  (3)   ( Linux man: Библиотечные вызовы )   readv  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
