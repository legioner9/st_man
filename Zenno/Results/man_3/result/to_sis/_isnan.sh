...
  
 ...
 isnan (3)   isnan  (3)   ( Solaris man: Библиотечные вызовы )   isnan  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isnan  (3)   ( Русские man: Библиотечные вызовы )   isnan  (3)   ( Linux man: Библиотечные вызовы )   isnan  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
