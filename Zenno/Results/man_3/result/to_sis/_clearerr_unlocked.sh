...
  
 ...
 clearerr_unlocked (3)   clearerr_unlocked  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clearerr_unlocked  (3)   ( Русские man: Библиотечные вызовы )   clearerr_unlocked  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
