...
  
 ...
 setpwent (3)   setpwent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setpwent  (3)   ( Русские man: Библиотечные вызовы )   setpwent  (3)   ( Linux man: Библиотечные вызовы )   setpwent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
