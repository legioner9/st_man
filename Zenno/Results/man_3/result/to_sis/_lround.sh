...
  
 ...
 lround (3)   lround  (3)   ( Solaris man: Библиотечные вызовы )   lround  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  lround  (3)   ( Русские man: Библиотечные вызовы )   lround  (3)   ( Linux man: Библиотечные вызовы )   lround  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
