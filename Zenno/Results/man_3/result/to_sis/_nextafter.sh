...
  
 ...
 nextafter (3)   nextafter  (3)   ( Solaris man: Библиотечные вызовы )   nextafter  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  nextafter  (3)   ( Русские man: Библиотечные вызовы )   nextafter  (3)   ( Linux man: Библиотечные вызовы )   nextafter  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
