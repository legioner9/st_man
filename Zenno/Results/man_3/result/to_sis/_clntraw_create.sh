...
  
 ...
 clntraw_create (3)   clntraw_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clntraw_create  (3)   ( Русские man: Библиотечные вызовы )   clntraw_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
