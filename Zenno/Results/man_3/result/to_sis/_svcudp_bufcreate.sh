...
  
 ...
 svcudp_bufcreate (3)   svcudp_bufcreate  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svcudp_bufcreate  (3)   ( Русские man: Библиотечные вызовы )   svcudp_bufcreate  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
