...
  
 ...
 closelog (3)   closelog  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  closelog  (3)   ( Русские man: Библиотечные вызовы )   closelog  (3)   ( Linux man: Библиотечные вызовы )   closelog  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
