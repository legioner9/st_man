...
  
 ...
 clnt_spcreateerror (3)   clnt_spcreateerror  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clnt_spcreateerror  (3)   ( Русские man: Библиотечные вызовы )   clnt_spcreateerror  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
