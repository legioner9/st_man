...
  
 ...
 fesetexceptflag (3)   fesetexceptflag  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fesetexceptflag  (3)   ( Русские man: Библиотечные вызовы )   fesetexceptflag  (3)   ( Linux man: Библиотечные вызовы )   fesetexceptflag  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
