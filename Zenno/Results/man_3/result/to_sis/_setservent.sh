...
  
 ...
 setservent (3)   setservent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setservent  (3)   ( Русские man: Библиотечные вызовы )   setservent  (3)   ( Linux man: Библиотечные вызовы )   setservent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
