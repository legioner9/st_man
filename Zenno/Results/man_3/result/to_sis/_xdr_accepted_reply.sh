...
  
 ...
 xdr_accepted_reply (3)   xdr_accepted_reply  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdr_accepted_reply  (3)   ( Русские man: Библиотечные вызовы )   xdr_accepted_reply  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
