...
  
 ...
 ispunct (3)   ispunct  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ispunct  (3)   ( Русские man: Библиотечные вызовы )   ispunct  (3)   ( Linux man: Библиотечные вызовы )   ispunct  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
