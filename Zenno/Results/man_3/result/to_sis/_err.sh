...
  
 ...
 err (3)   err  (3)   ( Solaris man: Библиотечные вызовы )   err  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  err  (3)   ( Русские man: Библиотечные вызовы )   err  (3)   ( Linux man: Библиотечные вызовы ) BSD mandoc 
   
 НАЗВАНИЕ 
