...
  
 ...
 getpwuid (3)   getpwuid  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getpwuid  (3)   ( Русские man: Библиотечные вызовы )   getpwuid  (3)   ( Linux man: Библиотечные вызовы )   getpwuid  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
