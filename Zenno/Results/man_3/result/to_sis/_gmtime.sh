...
  
 ...
 gmtime (3)   gmtime  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  gmtime  (3)   ( Русские man: Библиотечные вызовы )   gmtime  (3)   ( Linux man: Библиотечные вызовы )   gmtime  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
