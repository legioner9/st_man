...
  
 ...
 rcmd (3)   rcmd  (3)   ( Solaris man: Библиотечные вызовы )   rcmd  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  rcmd  (3)   ( Русские man: Библиотечные вызовы )   rcmd  (3)   ( Linux man: Библиотечные вызовы ) BSD mandoc 
BSD 4.2
