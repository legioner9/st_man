...
  
 ...
 endhostent (3)   endhostent  (3)   ( Solaris man: Библиотечные вызовы )   endhostent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  endhostent  (3)   ( Русские man: Библиотечные вызовы )   endhostent  (3)   ( Linux man: Библиотечные вызовы )   endhostent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
