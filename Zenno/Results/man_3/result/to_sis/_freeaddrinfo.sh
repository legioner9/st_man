...
  
 ...
 freeaddrinfo (3)   freeaddrinfo  (3)   ( Solaris man: Библиотечные вызовы )   freeaddrinfo  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  freeaddrinfo  (3)   ( Русские man: Библиотечные вызовы )   freeaddrinfo  (3)   ( Linux man: Библиотечные вызовы )   freeaddrinfo  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
