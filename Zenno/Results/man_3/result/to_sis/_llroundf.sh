...
  
 ...
 llroundf (3)   llroundf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  llroundf  (3)   ( Русские man: Библиотечные вызовы )   llroundf  (3)   ( Linux man: Библиотечные вызовы )   llroundf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
