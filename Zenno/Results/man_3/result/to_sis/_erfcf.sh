...
  
 ...
 erfcf (3)   erfcf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  erfcf  (3)   ( Русские man: Библиотечные вызовы )   erfcf  (3)   ( Linux man: Библиотечные вызовы )   erfcf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
