...
  
 ...
 getchar_unlocked (3)   getchar_unlocked  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getchar_unlocked  (3)   ( Русские man: Библиотечные вызовы )   getchar_unlocked  (3)   ( Linux man: Библиотечные вызовы )   getchar_unlocked  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
