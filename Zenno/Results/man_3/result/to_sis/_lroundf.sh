...
  
 ...
 lroundf (3)   lroundf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  lroundf  (3)   ( Русские man: Библиотечные вызовы )   lroundf  (3)   ( Linux man: Библиотечные вызовы )   lroundf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
