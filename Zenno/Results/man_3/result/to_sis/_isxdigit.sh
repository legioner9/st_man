...
  
 ...
 isxdigit (3)   isxdigit  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isxdigit  (3)   ( Русские man: Библиотечные вызовы )   isxdigit  (3)   ( Linux man: Библиотечные вызовы )   isxdigit  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
