...
  
 ...
 islessgreater (3)   islessgreater  (3)   ( Solaris man: Библиотечные вызовы )   islessgreater  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  islessgreater  (3)   ( Русские man: Библиотечные вызовы )   islessgreater  (3)   ( Linux man: Библиотечные вызовы )   islessgreater  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
