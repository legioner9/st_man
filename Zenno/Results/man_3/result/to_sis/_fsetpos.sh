...
  
 ...
 fsetpos (3)   fsetpos  (3)   ( Solaris man: Библиотечные вызовы )   fsetpos  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fsetpos  (3)   ( Русские man: Библиотечные вызовы )   fsetpos  (3)   ( Linux man: Библиотечные вызовы )   fsetpos  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
