...
  
 ...
 svcerr_noproc (3)   svcerr_noproc  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svcerr_noproc  (3)   ( Русские man: Библиотечные вызовы )   svcerr_noproc  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
