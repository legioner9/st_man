...
  
 ...
 fscanf (3)   fscanf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fscanf  (3)   ( Русские man: Библиотечные вызовы )   fscanf  (3)   ( Linux man: Библиотечные вызовы )   fscanf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
