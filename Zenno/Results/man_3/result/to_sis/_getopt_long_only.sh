...
  
 ...
 getopt_long_only (3)   getopt_long_only  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getopt_long_only  (3)   ( Русские man: Библиотечные вызовы )   getopt_long_only  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
