...
  
 ...
 getipnodebyname (3)   getipnodebyname  (3)   ( Solaris man: Библиотечные вызовы )   getipnodebyname  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getipnodebyname  (3)   ( Русские man: Библиотечные вызовы )   getipnodebyname  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
