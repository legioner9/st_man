...
  
 ...
 vsyslog (3)   vsyslog  (3)   ( Solaris man: Библиотечные вызовы )   vsyslog  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  vsyslog  (3)   ( Русские man: Библиотечные вызовы )   vsyslog  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
