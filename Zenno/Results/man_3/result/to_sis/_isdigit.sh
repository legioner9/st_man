...
  
 ...
 isdigit (3)   isdigit  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isdigit  (3)   ( Русские man: Библиотечные вызовы )   isdigit  (3)   ( Linux man: Библиотечные вызовы )   isdigit  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
