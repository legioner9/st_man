...
  
 ...
 xdrrec_create (3)   xdrrec_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdrrec_create  (3)   ( Русские man: Библиотечные вызовы )   xdrrec_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
