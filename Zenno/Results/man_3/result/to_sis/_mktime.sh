...
  
 ...
 mktime (3)   mktime  (3)   ( Solaris man: Библиотечные вызовы )   mktime  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  mktime  (3)   ( Русские man: Библиотечные вызовы )   mktime  (3)   ( Linux man: Библиотечные вызовы )   mktime  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
