...
  
 ...
 tcsendbreak (3)   tcsendbreak  (3)   ( Solaris man: Библиотечные вызовы )   tcsendbreak  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  tcsendbreak  (3)   ( Русские man: Библиотечные вызовы )   tcsendbreak  (3)   ( Linux man: Библиотечные вызовы )   tcsendbreak  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
