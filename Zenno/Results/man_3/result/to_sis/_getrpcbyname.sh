...
  
 ...
 getrpcbyname (3)   getrpcbyname  (3)   ( Solaris man: Библиотечные вызовы )   getrpcbyname  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getrpcbyname  (3)   ( Русские man: Библиотечные вызовы )   getrpcbyname  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
