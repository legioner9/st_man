...
  
 ...
 ctime (3)   ctime  (3)   ( Solaris man: Библиотечные вызовы )   ctime  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ctime  (3)   ( Русские man: Библиотечные вызовы )   ctime  (3)   ( Linux man: Библиотечные вызовы )   ctime  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
