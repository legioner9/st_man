...
  
 ...
 vfscanf (3)   vfscanf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  vfscanf  (3)   ( Русские man: Библиотечные вызовы )   vfscanf  (3)   ( Linux man: Библиотечные вызовы )   vfscanf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
