...
  
 ...
 xdr_opaque_auth (3)   xdr_opaque_auth  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdr_opaque_auth  (3)   ( Русские man: Библиотечные вызовы )   xdr_opaque_auth  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
