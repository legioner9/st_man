...
  
 ...
 strcasecmp (3)   strcasecmp  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  strcasecmp  (3)   ( Русские man: Библиотечные вызовы )   strcasecmp  (3)   ( Linux man: Библиотечные вызовы )   strcasecmp  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
