...
  
 ...
 inet_addr (3)   inet_addr  (3)   ( Solaris man: Библиотечные вызовы )   inet_addr  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  inet_addr  (3)   ( Русские man: Библиотечные вызовы )   inet_addr  (3)   ( Linux man: Библиотечные вызовы )   inet_addr  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
