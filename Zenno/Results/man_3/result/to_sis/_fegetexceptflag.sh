...
  
 ...
 fegetexceptflag (3)   fegetexceptflag  (3)   ( Solaris man: Библиотечные вызовы )   fegetexceptflag  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fegetexceptflag  (3)   ( Русские man: Библиотечные вызовы )   fegetexceptflag  (3)   ( Linux man: Библиотечные вызовы )   fegetexceptflag  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
