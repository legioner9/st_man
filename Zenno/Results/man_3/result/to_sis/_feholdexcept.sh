...
  
 ...
 feholdexcept (3)   feholdexcept  (3)   ( Solaris man: Библиотечные вызовы )   feholdexcept  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  feholdexcept  (3)   ( Русские man: Библиотечные вызовы )   feholdexcept  (3)   ( Linux man: Библиотечные вызовы )   feholdexcept  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
