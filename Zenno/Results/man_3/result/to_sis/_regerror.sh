...
  
 ...
 regerror (3)   regerror  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  regerror  (3)   ( Русские man: Библиотечные вызовы )   regerror  (3)   ( Linux man: Библиотечные вызовы )   regerror  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
