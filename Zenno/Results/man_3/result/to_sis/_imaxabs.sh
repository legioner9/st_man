...
  
 ...
 imaxabs (3)   imaxabs  (3)   ( Solaris man: Библиотечные вызовы )   imaxabs  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  imaxabs  (3)   ( Русские man: Библиотечные вызовы )   imaxabs  (3)   ( Linux man: Библиотечные вызовы )   imaxabs  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
