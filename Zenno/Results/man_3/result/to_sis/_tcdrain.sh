...
  
 ...
 tcdrain (3)   tcdrain  (3)   ( Solaris man: Библиотечные вызовы )   tcdrain  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  tcdrain  (3)   ( Русские man: Библиотечные вызовы )   tcdrain  (3)   ( Linux man: Библиотечные вызовы )   tcdrain  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
