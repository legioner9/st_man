...
  
 ...
 insque (3)   insque  (3)   ( Solaris man: Библиотечные вызовы )   insque  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  insque  (3)   ( Русские man: Библиотечные вызовы )   insque  (3)   ( Linux man: Библиотечные вызовы )   insque  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
