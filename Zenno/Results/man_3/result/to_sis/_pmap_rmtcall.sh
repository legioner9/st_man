...
  
 ...
 pmap_rmtcall (3)   pmap_rmtcall  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  pmap_rmtcall  (3)   ( Русские man: Библиотечные вызовы )   pmap_rmtcall  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
