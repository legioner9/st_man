...
  
 ...
 nextafterl (3)   nextafterl  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  nextafterl  (3)   ( Русские man: Библиотечные вызовы )   nextafterl  (3)   ( Linux man: Библиотечные вызовы )   nextafterl  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
