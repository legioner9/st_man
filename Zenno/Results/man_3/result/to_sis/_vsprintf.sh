...
  
 ...
 vsprintf (3)   vsprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  vsprintf  (3)   ( Русские man: Библиотечные вызовы )   vsprintf  (3)   ( Linux man: Библиотечные вызовы )   vsprintf  (3)   ( POSIX man: Библиотечные вызовы )   vsprintf  (9)   ( Solaris man: Ядро ) 
   
 НАЗВАНИЕ 
