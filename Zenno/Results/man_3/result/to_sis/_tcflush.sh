...
  
 ...
 tcflush (3)   tcflush  (3)   ( Solaris man: Библиотечные вызовы )   tcflush  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  tcflush  (3)   ( Русские man: Библиотечные вызовы )   tcflush  (3)   ( Linux man: Библиотечные вызовы )   tcflush  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
