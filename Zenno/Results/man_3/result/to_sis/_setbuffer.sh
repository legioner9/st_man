...
  
 ...
 setbuffer (3)   setbuffer  (3)   ( Solaris man: Библиотечные вызовы )   setbuffer  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setbuffer  (3)   ( Русские man: Библиотечные вызовы )   setbuffer  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
