...
  
 ...
 gethostbyaddr (3)   gethostbyaddr  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  gethostbyaddr  (3)   ( Русские man: Библиотечные вызовы )   gethostbyaddr  (3)   ( Linux man: Библиотечные вызовы )   gethostbyaddr  (3)   ( POSIX man: Библиотечные вызовы ) Ключ  gethostbyaddr  обнаружен в базе ключевых слов. 
   
 НАЗВАНИЕ 
