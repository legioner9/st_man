...
  
 ...
 strncpy (3)   strncpy  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  strncpy  (3)   ( Русские man: Библиотечные вызовы )   strncpy  (3)   ( Linux man: Библиотечные вызовы )   strncpy  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
