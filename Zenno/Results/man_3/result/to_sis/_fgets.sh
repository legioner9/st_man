...
  
 ...
 fgets (3)   fgets  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fgets  (3)   ( Русские man: Библиотечные вызовы )   fgets  (3)   ( Linux man: Библиотечные вызовы )   fgets  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
