...
  
 ...
 ungetc (3)   ungetc  (3)   ( Solaris man: Библиотечные вызовы )   ungetc  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ungetc  (3)   ( Русские man: Библиотечные вызовы )   ungetc  (3)   ( Linux man: Библиотечные вызовы )   ungetc  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
