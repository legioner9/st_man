...
  
 ...
 sigismember (3)   sigismember  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  sigismember  (3)   ( Русские man: Библиотечные вызовы )   sigismember  (3)   ( Linux man: Библиотечные вызовы )   sigismember  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
