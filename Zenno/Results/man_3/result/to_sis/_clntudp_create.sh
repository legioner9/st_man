...
  
 ...
 clntudp_create (3)   clntudp_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clntudp_create  (3)   ( Русские man: Библиотечные вызовы )   clntudp_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
