...
  
 ...
 sscanf (3)   sscanf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  sscanf  (3)   ( Русские man: Библиотечные вызовы )   sscanf  (3)   ( Linux man: Библиотечные вызовы )   sscanf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
