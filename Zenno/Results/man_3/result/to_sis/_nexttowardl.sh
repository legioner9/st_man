...
  
 ...
 nexttowardl (3)   nexttowardl  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  nexttowardl  (3)   ( Русские man: Библиотечные вызовы )   nexttowardl  (3)   ( Linux man: Библиотечные вызовы )   nexttowardl  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
