...
  
 ...
 dlerror (3)   dlerror  (3)   ( Solaris man: Библиотечные вызовы )   dlerror  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  dlerror  (3)   ( Русские man: Библиотечные вызовы )   dlerror  (3)   ( Linux man: Библиотечные вызовы )   dlerror  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
