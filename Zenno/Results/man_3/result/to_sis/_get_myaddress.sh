...
  
 ...
 get_myaddress (3)   get_myaddress  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  get_myaddress  (3)   ( Русские man: Библиотечные вызовы )   get_myaddress  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
