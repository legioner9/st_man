...
  
 ...
 strerror_r (3)   strerror_r  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  strerror_r  (3)   ( Русские man: Библиотечные вызовы )   strerror_r  (3)   ( Linux man: Библиотечные вызовы )   strerror_r  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
