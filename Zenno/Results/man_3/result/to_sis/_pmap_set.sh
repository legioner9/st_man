...
  
 ...
 pmap_set (3)   pmap_set  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  pmap_set  (3)   ( Русские man: Библиотечные вызовы )   pmap_set  (3)   ( Linux man: Библиотечные вызовы )   pmap_set  (8)   ( Linux man: Команды системного администрирования ) 
   
 НАЗВАНИЕ 
