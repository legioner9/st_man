...
  
 ...
 getgrent (3)   getgrent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getgrent  (3)   ( Русские man: Библиотечные вызовы )   getgrent  (3)   ( Linux man: Библиотечные вызовы )   getgrent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
