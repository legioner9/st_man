...
  
 ...
 fopen (3)   fopen  (3)   ( Solaris man: Библиотечные вызовы )   fopen  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fopen  (3)   ( Русские man: Библиотечные вызовы )   fopen  (3)   ( Linux man: Библиотечные вызовы )   fopen  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
