...
  
 ...
 freopen (3)   freopen  (3)   ( Solaris man: Библиотечные вызовы )   freopen  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  freopen  (3)   ( Русские man: Библиотечные вызовы )   freopen  (3)   ( Linux man: Библиотечные вызовы )   freopen  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
