...
  
 ...
 xdrstdio_create (3)   xdrstdio_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdrstdio_create  (3)   ( Русские man: Библиотечные вызовы )   xdrstdio_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
