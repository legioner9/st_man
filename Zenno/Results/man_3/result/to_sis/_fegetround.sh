...
  
 ...
 fegetround (3)   fegetround  (3)   ( Solaris man: Библиотечные вызовы )   fegetround  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fegetround  (3)   ( Русские man: Библиотечные вызовы )   fegetround  (3)   ( Linux man: Библиотечные вызовы )   fegetround  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
