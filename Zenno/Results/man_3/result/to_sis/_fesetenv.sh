...
  
 ...
 fesetenv (3)   fesetenv  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fesetenv  (3)   ( Русские man: Библиотечные вызовы )   fesetenv  (3)   ( Linux man: Библиотечные вызовы )   fesetenv  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
