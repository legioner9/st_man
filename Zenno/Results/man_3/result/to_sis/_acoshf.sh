...
  
 ...
 acoshf (3)   acoshf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  acoshf  (3)   ( Русские man: Библиотечные вызовы )   acoshf  (3)   ( Linux man: Библиотечные вызовы )   acoshf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
