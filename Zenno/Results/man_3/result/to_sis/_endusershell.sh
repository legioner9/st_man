...
  
 ...
 endusershell (3)   endusershell  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  endusershell  (3)   ( Русские man: Библиотечные вызовы )   endusershell  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
