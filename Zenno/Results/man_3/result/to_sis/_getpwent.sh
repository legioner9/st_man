...
  
 ...
 getpwent (3)   getpwent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getpwent  (3)   ( Русские man: Библиотечные вызовы )   getpwent  (3)   ( Linux man: Библиотечные вызовы )   getpwent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
