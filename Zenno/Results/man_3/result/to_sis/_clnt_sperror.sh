...
  
 ...
 clnt_sperror (3)   clnt_sperror  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clnt_sperror  (3)   ( Русские man: Библиотечные вызовы )   clnt_sperror  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
