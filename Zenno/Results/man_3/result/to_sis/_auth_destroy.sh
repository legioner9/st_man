...
  
 ...
 auth_destroy (3)   auth_destroy  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  auth_destroy  (3)   ( Русские man: Библиотечные вызовы )   auth_destroy  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
