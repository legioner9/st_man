...
  
 ...
 cfsetispeed (3)   cfsetispeed  (3)   ( Solaris man: Библиотечные вызовы )   cfsetispeed  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  cfsetispeed  (3)   ( Русские man: Библиотечные вызовы )   cfsetispeed  (3)   ( Linux man: Библиотечные вызовы )   cfsetispeed  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
