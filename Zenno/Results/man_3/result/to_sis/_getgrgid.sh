...
  
 ...
 getgrgid (3)   getgrgid  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getgrgid  (3)   ( Русские man: Библиотечные вызовы )   getgrgid  (3)   ( Linux man: Библиотечные вызовы )   getgrgid  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
