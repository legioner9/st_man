...
  
 ...
 svc_unregister (3)   svc_unregister  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svc_unregister  (3)   ( Русские man: Библиотечные вызовы )   svc_unregister  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
