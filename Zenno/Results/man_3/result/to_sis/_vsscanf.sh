...
  
 ...
 vsscanf (3)   vsscanf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  vsscanf  (3)   ( Русские man: Библиотечные вызовы )   vsscanf  (3)   ( Linux man: Библиотечные вызовы )   vsscanf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
