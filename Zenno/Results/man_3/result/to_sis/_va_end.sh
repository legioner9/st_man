...
  
 ...
 va_end (3)   va_end  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  va_end  (3)   ( Русские man: Библиотечные вызовы )   va_end  (3)   ( Linux man: Библиотечные вызовы )   va_end  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
