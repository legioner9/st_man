...
  
 ...
 log1pf (3)   log1pf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  log1pf  (3)   ( Русские man: Библиотечные вызовы )   log1pf  (3)   ( Linux man: Библиотечные вызовы )   log1pf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
