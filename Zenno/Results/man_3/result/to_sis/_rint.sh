...
  
 ...
 rint (3)   rint  (3)   ( Solaris man: Библиотечные вызовы )   rint  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  rint  (3)   ( Русские man: Библиотечные вызовы )   rint  (3)   ( Linux man: Библиотечные вызовы )   rint  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
