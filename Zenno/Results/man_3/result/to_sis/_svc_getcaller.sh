...
  
 ...
 svc_getcaller (3)   svc_getcaller  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svc_getcaller  (3)   ( Русские man: Библиотечные вызовы )   svc_getcaller  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
