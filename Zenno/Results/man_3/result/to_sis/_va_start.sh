...
  
 ...
 va_start (3)   va_start  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  va_start  (3)   ( Русские man: Библиотечные вызовы )   va_start  (3)   ( Linux man: Библиотечные вызовы )   va_start  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
