...
  
 ...
 abs (3)   abs  (3)   ( Solaris man: Библиотечные вызовы )   abs  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  abs  (3)   ( Русские man: Библиотечные вызовы )   abs  (3)   ( Linux man: Библиотечные вызовы )   abs  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
