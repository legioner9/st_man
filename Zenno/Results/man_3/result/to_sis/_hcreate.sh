...
  
 ...
 hcreate (3)   hcreate  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  hcreate  (3)   ( Русские man: Библиотечные вызовы )   hcreate  (3)   ( Linux man: Библиотечные вызовы )   hcreate  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
