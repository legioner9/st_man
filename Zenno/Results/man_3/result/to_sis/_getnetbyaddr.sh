...
  
 ...
 getnetbyaddr (3)   getnetbyaddr  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getnetbyaddr  (3)   ( Русские man: Библиотечные вызовы )   getnetbyaddr  (3)   ( Linux man: Библиотечные вызовы )   getnetbyaddr  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
