...
  
 ...
 hsearch (3)   hsearch  (3)   ( Solaris man: Библиотечные вызовы )   hsearch  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  hsearch  (3)   ( Русские man: Библиотечные вызовы )   hsearch  (3)   ( Linux man: Библиотечные вызовы )   hsearch  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
