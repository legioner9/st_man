...
  
 ...
 execv (3)   execv  (2)   ( Solaris man: Системные вызовы )   execv  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  execv  (3)   ( Русские man: Библиотечные вызовы )   execv  (3)   ( Linux man: Библиотечные вызовы )   execv  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
