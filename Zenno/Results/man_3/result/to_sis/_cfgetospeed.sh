...
  
 ...
 cfgetospeed (3)   cfgetospeed  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  cfgetospeed  (3)   ( Русские man: Библиотечные вызовы )   cfgetospeed  (3)   ( Linux man: Библиотечные вызовы )   cfgetospeed  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
