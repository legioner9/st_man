...
  
 ...
 copysignl (3)   copysignl  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  copysignl  (3)   ( Русские man: Библиотечные вызовы )   copysignl  (3)   ( Linux man: Библиотечные вызовы )   copysignl  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
