...
  
 ...
 vfprintf (3)   vfprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  vfprintf  (3)   ( Русские man: Библиотечные вызовы )   vfprintf  (3)   ( Linux man: Библиотечные вызовы )   vfprintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
