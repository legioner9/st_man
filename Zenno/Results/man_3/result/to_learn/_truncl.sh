...
  
 ...
 truncl (3)   truncl  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  truncl  (3)   ( Русские man: Библиотечные вызовы )   truncl  (3)   ( Linux man: Библиотечные вызовы )   truncl  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
