...
  
 ...
 execvp (3)   execvp  (2)   ( Solaris man: Системные вызовы )   execvp  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  execvp  (3)   ( Русские man: Библиотечные вызовы )   execvp  (3)   ( Linux man: Библиотечные вызовы )   execvp  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
