...
  
 ...
 ether_hostton (3)   ether_hostton  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ether_hostton  (3)   ( Русские man: Библиотечные вызовы )   ether_hostton  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
