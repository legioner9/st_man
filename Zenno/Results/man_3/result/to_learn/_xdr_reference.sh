...
  
 ...
 xdr_reference (3)   xdr_reference  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdr_reference  (3)   ( Русские man: Библиотечные вызовы )   xdr_reference  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
