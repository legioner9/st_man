...
  
 ...
 getservbyname (3)   getservbyname  (3)   ( Solaris man: Библиотечные вызовы )   getservbyname  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getservbyname  (3)   ( Русские man: Библиотечные вызовы )   getservbyname  (3)   ( Linux man: Библиотечные вызовы )   getservbyname  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
