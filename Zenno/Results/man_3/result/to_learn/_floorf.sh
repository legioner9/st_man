...
  
 ...
 floorf (3)   floorf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  floorf  (3)   ( Русские man: Библиотечные вызовы )   floorf  (3)   ( Linux man: Библиотечные вызовы )   floorf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
