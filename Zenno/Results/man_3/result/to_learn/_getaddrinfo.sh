...
  
 ...
 getaddrinfo (3)   getaddrinfo  (3)   ( Solaris man: Библиотечные вызовы )   getaddrinfo  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getaddrinfo  (3)   ( Русские man: Библиотечные вызовы )   getaddrinfo  (3)   ( Linux man: Библиотечные вызовы )   getaddrinfo  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
