...
  
 ...
 svcerr_progvers (3)   svcerr_progvers  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svcerr_progvers  (3)   ( Русские man: Библиотечные вызовы )   svcerr_progvers  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
