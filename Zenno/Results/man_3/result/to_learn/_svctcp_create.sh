...
  
 ...
 svctcp_create (3)   svctcp_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svctcp_create  (3)   ( Русские man: Библиотечные вызовы )   svctcp_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
