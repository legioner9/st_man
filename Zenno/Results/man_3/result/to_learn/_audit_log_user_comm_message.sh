...
  
 ...
 audit_log_user_comm_message (3) >>  audit_log_user_comm_message  (3)   ( Русские man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 

audit_log_user_comm_message - регистрация сообщений пользователя из консольных приложений
   
 СИНТАКСИС 
...
Эта функция должна использоваться всеми консольными приложениями, которые не производят операции с
пользователями или группами и выполняют скрипты. Например, показать запуск python или crond.
Параметры функции следующие:
 
 audit_fd - дескриптор, возвращённый audit_open
type - тип сообщения. Например: AUDIT_USYS_CONFIG, AUDIT_USER_LOGIN
message - текст сообщения
comm - название консольной программы
