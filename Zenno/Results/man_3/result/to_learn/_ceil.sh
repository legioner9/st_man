...
  
 ...
 ceil (3)   ceil  (3)   ( Solaris man: Библиотечные вызовы )   ceil  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ceil  (3)   ( Русские man: Библиотечные вызовы )   ceil  (3)   ( Linux man: Библиотечные вызовы )   ceil  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
