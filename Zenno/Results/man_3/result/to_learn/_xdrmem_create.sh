...
  
 ...
 xdrmem_create (3)   xdrmem_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdrmem_create  (3)   ( Русские man: Библиотечные вызовы )   xdrmem_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
