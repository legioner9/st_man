...
  
 ...
 getutxent (3)   getutxent  (3)   ( Solaris man: Библиотечные вызовы ) >>  getutxent  (3)   ( Русские man: Библиотечные вызовы )   getutxent  (3)   ( Linux man: Библиотечные вызовы )   getutxent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
