...
  
 ...
 strtof (3)   strtof  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  strtof  (3)   ( Русские man: Библиотечные вызовы )   strtof  (3)   ( Linux man: Библиотечные вызовы )   strtof  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
