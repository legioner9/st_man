...
  
 ...
 auparse_find_field_next (3) >>  auparse_find_field_next  (3)   ( Русские man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 

auparse_find_field_next - находит следующее поле по заданному имени
   
 СИНТАКСИС 
...
auparse_find_field_next находит следующее поле с заданным именем. Сканирует до достижения последней записи текущего события.
