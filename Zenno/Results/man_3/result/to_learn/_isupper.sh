...
  
 ...
 isupper (3)   isupper  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isupper  (3)   ( Русские man: Библиотечные вызовы )   isupper  (3)   ( Linux man: Библиотечные вызовы )   isupper  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
