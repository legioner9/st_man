...
  
 ...
 clnt_freeres (3)   clnt_freeres  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clnt_freeres  (3)   ( Русские man: Библиотечные вызовы )   clnt_freeres  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
