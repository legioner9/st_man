...
  
 ...
 nextafterf (3)   nextafterf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  nextafterf  (3)   ( Русские man: Библиотечные вызовы )   nextafterf  (3)   ( Linux man: Библиотечные вызовы )   nextafterf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
