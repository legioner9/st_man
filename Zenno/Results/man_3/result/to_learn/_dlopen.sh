...
  
 ...
 dlopen (3)   dlopen  (3)   ( Solaris man: Библиотечные вызовы )   dlopen  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  dlopen  (3)   ( Русские man: Библиотечные вызовы )   dlopen  (3)   ( Linux man: Библиотечные вызовы )   dlopen  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
