...
  
 ...
 execlp (3)   execlp  (2)   ( Solaris man: Системные вызовы )   execlp  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  execlp  (3)   ( Русские man: Библиотечные вызовы )   execlp  (3)   ( Linux man: Библиотечные вызовы )   execlp  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
