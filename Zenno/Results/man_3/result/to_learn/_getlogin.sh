...
  
 ...
 getlogin (3)   getlogin  (2)   ( FreeBSD man: Системные вызовы )   getlogin  (3)   ( Solaris man: Библиотечные вызовы ) >>  getlogin  (3)   ( Русские man: Библиотечные вызовы )   getlogin  (3)   ( Linux man: Библиотечные вызовы )   getlogin  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
