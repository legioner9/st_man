...
  
 ...
 xdr_pmaplist (3)   xdr_pmaplist  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdr_pmaplist  (3)   ( Русские man: Библиотечные вызовы )   xdr_pmaplist  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
