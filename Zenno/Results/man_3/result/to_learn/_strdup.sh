...
  
 ...
 strdup (3)   strdup  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  strdup  (3)   ( Русские man: Библиотечные вызовы )   strdup  (3)   ( Linux man: Библиотечные вызовы )   strdup  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
