...
  
 ...
 carg (3)   carg  (3)   ( Solaris man: Библиотечные вызовы ) >>  carg  (3)   ( Русские man: Библиотечные вызовы )   carg  (3)   ( Linux man: Библиотечные вызовы )   carg  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
