...
  
 ...
 toupper (3)   toupper  (3)   ( Solaris man: Библиотечные вызовы )   toupper  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  toupper  (3)   ( Русские man: Библиотечные вызовы )   toupper  (3)   ( Linux man: Библиотечные вызовы )   toupper  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
