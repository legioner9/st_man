...
  
 ...
 getc_unlocked (3)   getc_unlocked  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getc_unlocked  (3)   ( Русские man: Библиотечные вызовы )   getc_unlocked  (3)   ( Linux man: Библиотечные вызовы )   getc_unlocked  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
