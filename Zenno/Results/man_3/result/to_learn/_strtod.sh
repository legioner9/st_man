...
  
 ...
 strtod (3)   strtod  (3)   ( Solaris man: Библиотечные вызовы )   strtod  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  strtod  (3)   ( Русские man: Библиотечные вызовы )   strtod  (3)   ( Linux man: Библиотечные вызовы )   strtod  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
