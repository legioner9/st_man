...
  
 ...
 ferror (3)   ferror  (3)   ( Solaris man: Библиотечные вызовы )   ferror  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ferror  (3)   ( Русские man: Библиотечные вызовы )   ferror  (3)   ( Linux man: Библиотечные вызовы )   ferror  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
