...
  
 ...
 twalk (3)   twalk  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  twalk  (3)   ( Русские man: Библиотечные вызовы )   twalk  (3)   ( Linux man: Библиотечные вызовы )   twalk  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
