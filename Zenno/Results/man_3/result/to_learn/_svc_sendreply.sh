...
  
 ...
 svc_sendreply (3)   svc_sendreply  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svc_sendreply  (3)   ( Русские man: Библиотечные вызовы )   svc_sendreply  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
