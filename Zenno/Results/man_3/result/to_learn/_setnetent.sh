...
  
 ...
 setnetent (3)   setnetent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setnetent  (3)   ( Русские man: Библиотечные вызовы )   setnetent  (3)   ( Linux man: Библиотечные вызовы )   setnetent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
