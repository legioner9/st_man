...
  
 ...
 isgraph (3)   isgraph  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isgraph  (3)   ( Русские man: Библиотечные вызовы )   isgraph  (3)   ( Linux man: Библиотечные вызовы )   isgraph  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
