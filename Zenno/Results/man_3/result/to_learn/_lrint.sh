...
  
 ...
 lrint (3)   lrint  (3)   ( Solaris man: Библиотечные вызовы )   lrint  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  lrint  (3)   ( Русские man: Библиотечные вызовы )   lrint  (3)   ( Linux man: Библиотечные вызовы )   lrint  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
