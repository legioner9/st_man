...
  
 ...
 fesetround (3)   fesetround  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fesetround  (3)   ( Русские man: Библиотечные вызовы )   fesetround  (3)   ( Linux man: Библиотечные вызовы )   fesetround  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
