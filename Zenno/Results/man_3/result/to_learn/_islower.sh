...
  
 ...
 islower (3)   islower  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  islower  (3)   ( Русские man: Библиотечные вызовы )   islower  (3)   ( Linux man: Библиотечные вызовы )   islower  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
