...
  
 ...
 gethostbyname (3)   gethostbyname  (3)   ( Solaris man: Библиотечные вызовы )   gethostbyname  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  gethostbyname  (3)   ( Русские man: Библиотечные вызовы )   gethostbyname  (3)   ( Linux man: Библиотечные вызовы )   gethostbyname  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
