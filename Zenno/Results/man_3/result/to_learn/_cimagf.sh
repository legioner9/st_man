...
  
 ...
 cimagf (3)   cimagf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  cimagf  (3)   ( Русские man: Библиотечные вызовы )   cimagf  (3)   ( Linux man: Библиотечные вызовы )   cimagf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
