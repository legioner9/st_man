...
  
 ...
 vsnprintf (3)   vsnprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  vsnprintf  (3)   ( Русские man: Библиотечные вызовы )   vsnprintf  (3)   ( Linux man: Библиотечные вызовы )   vsnprintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
