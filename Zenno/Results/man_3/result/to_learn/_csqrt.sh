...
  
 ...
 csqrt (3)   csqrt  (3)   ( Solaris man: Библиотечные вызовы ) >>  csqrt  (3)   ( Русские man: Библиотечные вызовы )   csqrt  (3)   ( Linux man: Библиотечные вызовы )   csqrt  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
