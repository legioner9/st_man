...
  
 ...
 svc_freeargs (3)   svc_freeargs  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svc_freeargs  (3)   ( Русские man: Библиотечные вызовы )   svc_freeargs  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
