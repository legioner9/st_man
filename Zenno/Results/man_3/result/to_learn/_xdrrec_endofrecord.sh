...
  
 ...
 xdrrec_endofrecord (3)   xdrrec_endofrecord  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdrrec_endofrecord  (3)   ( Русские man: Библиотечные вызовы )   xdrrec_endofrecord  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
