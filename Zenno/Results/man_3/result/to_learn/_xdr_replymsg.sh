...
  
 ...
 xdr_replymsg (3)   xdr_replymsg  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdr_replymsg  (3)   ( Русские man: Библиотечные вызовы )   xdr_replymsg  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
