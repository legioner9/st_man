...
  
 ...
 stdout (3) >>  stdout  (3)   ( Русские man: Библиотечные вызовы )   stdout  (3)   ( Linux man: Библиотечные вызовы )   stdout  (3)   ( POSIX man: Библиотечные вызовы )   stdout  (4)   ( FreeBSD man: Специальные файлы /dev/* ) BSD mandoc 
Linux 2.0
