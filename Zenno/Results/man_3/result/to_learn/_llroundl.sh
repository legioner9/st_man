...
  
 ...
 llroundl (3)   llroundl  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  llroundl  (3)   ( Русские man: Библиотечные вызовы )   llroundl  (3)   ( Linux man: Библиотечные вызовы )   llroundl  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
