...
  
 ...
 ftrylockfile (3)   ftrylockfile  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ftrylockfile  (3)   ( Русские man: Библиотечные вызовы )   ftrylockfile  (3)   ( Linux man: Библиотечные вызовы )   ftrylockfile  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
