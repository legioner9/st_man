...
  
 ...
 calloc (3)   calloc  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  calloc  (3)   ( Русские man: Библиотечные вызовы )   calloc  (3)   ( Linux man: Библиотечные вызовы )   calloc  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
