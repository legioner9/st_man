...
  
 ...
 svcfd_create (3)   svcfd_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svcfd_create  (3)   ( Русские man: Библиотечные вызовы )   svcfd_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
