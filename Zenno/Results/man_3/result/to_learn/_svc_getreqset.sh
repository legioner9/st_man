...
  
 ...
 svc_getreqset (3)   svc_getreqset  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svc_getreqset  (3)   ( Русские man: Библиотечные вызовы )   svc_getreqset  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
