...
  
 ...
 fread (3)   fread  (3)   ( Solaris man: Библиотечные вызовы )   fread  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fread  (3)   ( Русские man: Библиотечные вызовы )   fread  (3)   ( Linux man: Библиотечные вызовы )   fread  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
