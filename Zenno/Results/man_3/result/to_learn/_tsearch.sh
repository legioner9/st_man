...
  
 ...
 tsearch (3)   tsearch  (3)   ( Solaris man: Библиотечные вызовы )   tsearch  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  tsearch  (3)   ( Русские man: Библиотечные вызовы )   tsearch  (3)   ( Linux man: Библиотечные вызовы )   tsearch  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
