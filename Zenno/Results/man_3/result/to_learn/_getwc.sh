...
  
 ...
 getwc (3)   getwc  (3)   ( Solaris man: Библиотечные вызовы )   getwc  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getwc  (3)   ( Русские man: Библиотечные вызовы )   getwc  (3)   ( Linux man: Библиотечные вызовы )   getwc  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
