...
  
 ...
 svcerr_systemerr (3)   svcerr_systemerr  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svcerr_systemerr  (3)   ( Русские man: Библиотечные вызовы )   svcerr_systemerr  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
