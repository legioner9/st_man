...
  
 ...
 tcsetattr (3)   tcsetattr  (3)   ( Solaris man: Библиотечные вызовы )   tcsetattr  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  tcsetattr  (3)   ( Русские man: Библиотечные вызовы )   tcsetattr  (3)   ( Linux man: Библиотечные вызовы )   tcsetattr  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
