...
  
 ...
 getprotoent (3)   getprotoent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getprotoent  (3)   ( Русские man: Библиотечные вызовы )   getprotoent  (3)   ( Linux man: Библиотечные вызовы )   getprotoent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
