...
  
 ...
 isalpha (3)   isalpha  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isalpha  (3)   ( Русские man: Библиотечные вызовы )   isalpha  (3)   ( Linux man: Библиотечные вызовы )   isalpha  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
