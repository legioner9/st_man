...
  
 ...
 isspace (3)   isspace  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isspace  (3)   ( Русские man: Библиотечные вызовы )   isspace  (3)   ( Linux man: Библиотечные вызовы )   isspace  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
