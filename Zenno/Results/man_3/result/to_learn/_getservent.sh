...
  
 ...
 getservent (3)   getservent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getservent  (3)   ( Русские man: Библиотечные вызовы )   getservent  (3)   ( Linux man: Библиотечные вызовы )   getservent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
