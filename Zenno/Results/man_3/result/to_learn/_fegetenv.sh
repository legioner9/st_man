...
  
 ...
 fegetenv (3)   fegetenv  (3)   ( Solaris man: Библиотечные вызовы )   fegetenv  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fegetenv  (3)   ( Русские man: Библиотечные вызовы )   fegetenv  (3)   ( Linux man: Библиотечные вызовы )   fegetenv  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
