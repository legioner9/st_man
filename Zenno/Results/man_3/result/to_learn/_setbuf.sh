...
  
 ...
 setbuf (3)   setbuf  (3)   ( Solaris man: Библиотечные вызовы )   setbuf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setbuf  (3)   ( Русские man: Библиотечные вызовы )   setbuf  (3)   ( Linux man: Библиотечные вызовы )   setbuf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
