...
  
 ...
 vwprintf (3)   vwprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  vwprintf  (3)   ( Русские man: Библиотечные вызовы )   vwprintf  (3)   ( Linux man: Библиотечные вызовы )   vwprintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
