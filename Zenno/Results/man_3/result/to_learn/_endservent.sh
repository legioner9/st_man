...
  
 ...
 endservent (3)   endservent  (3)   ( Solaris man: Библиотечные вызовы )   endservent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  endservent  (3)   ( Русские man: Библиотечные вызовы )   endservent  (3)   ( Linux man: Библиотечные вызовы )   endservent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
