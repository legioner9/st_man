...
  
 ...
 execl (3)   execl  (2)   ( Solaris man: Системные вызовы )   execl  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  execl  (3)   ( Русские man: Библиотечные вызовы )   execl  (3)   ( Linux man: Библиотечные вызовы )   execl  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
