...
  
 ...
 svcraw_create (3)   svcraw_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svcraw_create  (3)   ( Русские man: Библиотечные вызовы )   svcraw_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
