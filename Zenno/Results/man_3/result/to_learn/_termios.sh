...
  
 ...
 termios (3)   termios  (3)   ( Solaris man: Библиотечные вызовы ) >>  termios  (3)   ( Русские man: Библиотечные вызовы )   termios  (3)   ( Linux man: Библиотечные вызовы )   termios  (4)   ( FreeBSD man: Специальные файлы /dev/* ) 
   
 НАЗВАНИЕ 
