...
  
 ...
 setvbuf (3)   setvbuf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setvbuf  (3)   ( Русские man: Библиотечные вызовы )   setvbuf  (3)   ( Linux man: Библиотечные вызовы )   setvbuf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
