...
  
 ...
 inet (3)   inet  (3)   ( Solaris man: Библиотечные вызовы )   inet  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  inet  (3)   ( Русские man: Библиотечные вызовы )   inet  (3)   ( Linux man: Библиотечные вызовы )   inet  (4)   ( FreeBSD man: Специальные файлы /dev/* )   inet  (7)   ( Solaris man: Макропакеты и соглашения ) 
   
 НАЗВАНИЕ 
