...
  
 ...
 fpclassify (3)   fpclassify  (3)   ( Solaris man: Библиотечные вызовы )   fpclassify  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fpclassify  (3)   ( Русские man: Библиотечные вызовы )   fpclassify  (3)   ( Linux man: Библиотечные вызовы )   fpclassify  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
