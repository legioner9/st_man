...
  
 ...
 asin (3)   asin  (3)   ( Solaris man: Библиотечные вызовы )   asin  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  asin  (3)   ( Русские man: Библиотечные вызовы )   asin  (3)   ( Linux man: Библиотечные вызовы )   asin  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
