...
  
 ...
 nearbyintf (3)   nearbyintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  nearbyintf  (3)   ( Русские man: Библиотечные вызовы )   nearbyintf  (3)   ( Linux man: Библиотечные вызовы )   nearbyintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
