...
  
 ...
 sigaddset (3)   sigaddset  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  sigaddset  (3)   ( Русские man: Библиотечные вызовы )   sigaddset  (3)   ( Linux man: Библиотечные вызовы )   sigaddset  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
