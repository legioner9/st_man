...
  
 ...
 fedisableexcept (3)   fedisableexcept  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fedisableexcept  (3)   ( Русские man: Библиотечные вызовы )   fedisableexcept  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
