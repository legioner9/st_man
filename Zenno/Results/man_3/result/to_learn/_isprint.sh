...
  
 ...
 isprint (3)   isprint  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isprint  (3)   ( Русские man: Библиотечные вызовы )   isprint  (3)   ( Linux man: Библиотечные вызовы )   isprint  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
