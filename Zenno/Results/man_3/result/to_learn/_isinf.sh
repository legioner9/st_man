...
  
 ...
 isinf (3)   isinf  (3)   ( Solaris man: Библиотечные вызовы )   isinf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isinf  (3)   ( Русские man: Библиотечные вызовы )   isinf  (3)   ( Linux man: Библиотечные вызовы )   isinf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
