...
  
 ...
 fwprintf (3)   fwprintf  (3)   ( Solaris man: Библиотечные вызовы )   fwprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fwprintf  (3)   ( Русские man: Библиотечные вызовы )   fwprintf  (3)   ( Linux man: Библиотечные вызовы )   fwprintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
