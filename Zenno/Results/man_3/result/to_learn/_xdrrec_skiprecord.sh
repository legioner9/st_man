...
  
 ...
 xdrrec_skiprecord (3)   xdrrec_skiprecord  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdrrec_skiprecord  (3)   ( Русские man: Библиотечные вызовы )   xdrrec_skiprecord  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
