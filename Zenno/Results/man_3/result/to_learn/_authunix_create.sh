...
  
 ...
 authunix_create (3)   authunix_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  authunix_create  (3)   ( Русские man: Библиотечные вызовы )   authunix_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
