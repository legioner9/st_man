...
  
 ...
 nearbyint (3)   nearbyint  (3)   ( Solaris man: Библиотечные вызовы )   nearbyint  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  nearbyint  (3)   ( Русские man: Библиотечные вызовы )   nearbyint  (3)   ( Linux man: Библиотечные вызовы )   nearbyint  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
