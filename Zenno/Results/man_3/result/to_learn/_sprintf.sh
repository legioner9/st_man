...
  
 ...
 sprintf (3)   sprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  sprintf  (3)   ( Русские man: Библиотечные вызовы )   sprintf  (3)   ( Linux man: Библиотечные вызовы )   sprintf  (3)   ( POSIX man: Библиотечные вызовы )   sprintf  (9)   ( Solaris man: Ядро ) 
   
 НАЗВАНИЕ 
