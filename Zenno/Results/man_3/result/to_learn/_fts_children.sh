...
  
 ...
 fts_children (3)   fts_children  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fts_children  (3)   ( Русские man: Библиотечные вызовы )   fts_children  (3)   ( Linux man: Библиотечные вызовы ) BSD mandoc 
   
 НАЗВАНИЕ 
