...
  
 ...
 clnt_sperrno (3)   clnt_sperrno  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clnt_sperrno  (3)   ( Русские man: Библиотечные вызовы )   clnt_sperrno  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
