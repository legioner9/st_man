...
  
 ...
 clnt_control (3)   clnt_control  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clnt_control  (3)   ( Русские man: Библиотечные вызовы )   clnt_control  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
