...
  
 ...
 erf (3)   erf  (3)   ( Solaris man: Библиотечные вызовы )   erf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  erf  (3)   ( Русские man: Библиотечные вызовы )   erf  (3)   ( Linux man: Библиотечные вызовы )   erf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
