...
  
 ...
 localtime (3)   localtime  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  localtime  (3)   ( Русские man: Библиотечные вызовы )   localtime  (3)   ( Linux man: Библиотечные вызовы )   localtime  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
