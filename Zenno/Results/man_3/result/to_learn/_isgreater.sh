...
  
 ...
 isgreater (3)   isgreater  (3)   ( Solaris man: Библиотечные вызовы )   isgreater  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isgreater  (3)   ( Русские man: Библиотечные вызовы )   isgreater  (3)   ( Linux man: Библиотечные вызовы )   isgreater  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
