...
  
 ...
 cfgetispeed (3)   cfgetispeed  (3)   ( Solaris man: Библиотечные вызовы )   cfgetispeed  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  cfgetispeed  (3)   ( Русские man: Библиотечные вызовы )   cfgetispeed  (3)   ( Linux man: Библиотечные вызовы )   cfgetispeed  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
