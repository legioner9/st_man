...
  
 ...
 erfc (3)   erfc  (3)   ( Solaris man: Библиотечные вызовы )   erfc  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  erfc  (3)   ( Русские man: Библиотечные вызовы )   erfc  (3)   ( Linux man: Библиотечные вызовы )   erfc  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
