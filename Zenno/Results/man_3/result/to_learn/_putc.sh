...
  
 ...
 putc (3)   putc  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  putc  (3)   ( Русские man: Библиотечные вызовы )   putc  (3)   ( Linux man: Библиотечные вызовы )   putc  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
