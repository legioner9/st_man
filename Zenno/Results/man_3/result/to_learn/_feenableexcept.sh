...
  
 ...
 feenableexcept (3)   feenableexcept  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  feenableexcept  (3)   ( Русские man: Библиотечные вызовы )   feenableexcept  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
