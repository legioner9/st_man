...
  
 ...
 cabsf (3)   cabsf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  cabsf  (3)   ( Русские man: Библиотечные вызовы )   cabsf  (3)   ( Linux man: Библиотечные вызовы )   cabsf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
