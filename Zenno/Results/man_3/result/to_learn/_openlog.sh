...
  
 ...
 openlog (3)   openlog  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  openlog  (3)   ( Русские man: Библиотечные вызовы )   openlog  (3)   ( Linux man: Библиотечные вызовы )   openlog  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
