...
  
 ...
 fseeko (3)   fseeko  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fseeko  (3)   ( Русские man: Библиотечные вызовы )   fseeko  (3)   ( Linux man: Библиотечные вызовы )   fseeko  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
