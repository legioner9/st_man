...
  
 ...
 authnone_create (3)   authnone_create  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  authnone_create  (3)   ( Русские man: Библиотечные вызовы )   authnone_create  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
