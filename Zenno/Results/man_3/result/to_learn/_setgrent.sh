...
  
 ...
 setgrent (3)   setgrent  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setgrent  (3)   ( Русские man: Библиотечные вызовы )   setgrent  (3)   ( Linux man: Библиотечные вызовы )   setgrent  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
