...
  
 ...
 hdestroy (3)   hdestroy  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  hdestroy  (3)   ( Русские man: Библиотечные вызовы )   hdestroy  (3)   ( Linux man: Библиотечные вызовы )   hdestroy  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
