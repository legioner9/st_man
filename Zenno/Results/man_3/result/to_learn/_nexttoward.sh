...
  
 ...
 nexttoward (3)   nexttoward  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  nexttoward  (3)   ( Русские man: Библиотечные вызовы )   nexttoward  (3)   ( Linux man: Библиотечные вызовы )   nexttoward  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
