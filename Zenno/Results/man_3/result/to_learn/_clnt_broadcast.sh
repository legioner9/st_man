...
  
 ...
 clnt_broadcast (3)   clnt_broadcast  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clnt_broadcast  (3)   ( Русские man: Библиотечные вызовы )   clnt_broadcast  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
