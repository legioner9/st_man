...
  
 ...
 getprotobynumber (3)   getprotobynumber  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getprotobynumber  (3)   ( Русские man: Библиотечные вызовы )   getprotobynumber  (3)   ( Linux man: Библиотечные вызовы )   getprotobynumber  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
