...
  
 ...
 puts (3)   puts  (3)   ( Solaris man: Библиотечные вызовы )   puts  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  puts  (3)   ( Русские man: Библиотечные вызовы )   puts  (3)   ( Linux man: Библиотечные вызовы )   puts  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
