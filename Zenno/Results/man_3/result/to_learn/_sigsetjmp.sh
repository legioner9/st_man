...
  
 ...
 sigsetjmp (3)   sigsetjmp  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  sigsetjmp  (3)   ( Русские man: Библиотечные вызовы )   sigsetjmp  (3)   ( Linux man: Библиотечные вызовы )   sigsetjmp  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
