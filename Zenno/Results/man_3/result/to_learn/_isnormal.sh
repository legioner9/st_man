...
  
 ...
 isnormal (3)   isnormal  (3)   ( Solaris man: Библиотечные вызовы )   isnormal  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isnormal  (3)   ( Русские man: Библиотечные вызовы )   isnormal  (3)   ( Linux man: Библиотечные вызовы )   isnormal  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
