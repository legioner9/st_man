...
  
 ...
 longjmp (3)   longjmp  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  longjmp  (3)   ( Русские man: Библиотечные вызовы )   longjmp  (3)   ( Linux man: Библиотечные вызовы )   longjmp  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
