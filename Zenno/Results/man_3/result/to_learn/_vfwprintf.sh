...
  
 ...
 vfwprintf (3)   vfwprintf  (3)   ( Solaris man: Библиотечные вызовы )   vfwprintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  vfwprintf  (3)   ( Русские man: Библиотечные вызовы )   vfwprintf  (3)   ( Linux man: Библиотечные вызовы )   vfwprintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
