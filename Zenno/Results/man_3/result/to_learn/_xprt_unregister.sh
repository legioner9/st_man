...
  
 ...
 xprt_unregister (3)   xprt_unregister  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xprt_unregister  (3)   ( Русские man: Библиотечные вызовы )   xprt_unregister  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
