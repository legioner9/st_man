...
  
 ...
 tcgetattr (3)   tcgetattr  (3)   ( Solaris man: Библиотечные вызовы )   tcgetattr  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  tcgetattr  (3)   ( Русские man: Библиотечные вызовы )   tcgetattr  (3)   ( Linux man: Библиотечные вызовы )   tcgetattr  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
