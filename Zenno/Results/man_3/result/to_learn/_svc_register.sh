...
  
 ...
 svc_register (3)   svc_register  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svc_register  (3)   ( Русские man: Библиотечные вызовы )   svc_register  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
