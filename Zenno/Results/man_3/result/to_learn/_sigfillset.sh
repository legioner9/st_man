...
  
 ...
 sigfillset (3)   sigfillset  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  sigfillset  (3)   ( Русские man: Библиотечные вызовы )   sigfillset  (3)   ( Linux man: Библиотечные вызовы )   sigfillset  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
