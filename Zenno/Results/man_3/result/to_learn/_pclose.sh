...
  
 ...
 pclose (3)   pclose  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  pclose  (3)   ( Русские man: Библиотечные вызовы )   pclose  (3)   ( Linux man: Библиотечные вызовы )   pclose  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
