...
  
 ...
 isblank (3)   isblank  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  isblank  (3)   ( Русские man: Библиотечные вызовы )   isblank  (3)   ( Linux man: Библиотечные вызовы )   isblank  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
