...
  
 ...
 regexec (3)   regexec  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  regexec  (3)   ( Русские man: Библиотечные вызовы )   regexec  (3)   ( Linux man: Библиотечные вызовы )   regexec  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
