...
  
 ...
 xdr_wrapstring (3)   xdr_wrapstring  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  xdr_wrapstring  (3)   ( Русские man: Библиотечные вызовы )   xdr_wrapstring  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
