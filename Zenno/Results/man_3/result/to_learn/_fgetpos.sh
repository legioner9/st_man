...
  
 ...
 fgetpos (3)   fgetpos  (3)   ( Solaris man: Библиотечные вызовы )   fgetpos  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fgetpos  (3)   ( Русские man: Библиотечные вызовы )   fgetpos  (3)   ( Linux man: Библиотечные вызовы )   fgetpos  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
