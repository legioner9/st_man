...
  
 ...
 setenv (3)   setenv  (1)   ( Solaris man: Команды и прикладные программы пользовательского уровня )   setenv  (1)   ( FreeBSD man: Команды и прикладные программы пользовательского уровня )   setenv  (3)   ( Solaris man: Библиотечные вызовы )   setenv  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  setenv  (3)   ( Русские man: Библиотечные вызовы )   setenv  (3)   ( Linux man: Библиотечные вызовы )   setenv  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
