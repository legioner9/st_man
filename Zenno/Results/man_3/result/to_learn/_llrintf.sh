...
  
 ...
 llrintf (3)   llrintf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  llrintf  (3)   ( Русские man: Библиотечные вызовы )   llrintf  (3)   ( Linux man: Библиотечные вызовы )   llrintf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
