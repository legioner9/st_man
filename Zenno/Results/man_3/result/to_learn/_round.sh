...
  
 ...
 round (3)   round  (3)   ( Solaris man: Библиотечные вызовы )   round  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  round  (3)   ( Русские man: Библиотечные вызовы )   round  (3)   ( Linux man: Библиотечные вызовы )   round  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
