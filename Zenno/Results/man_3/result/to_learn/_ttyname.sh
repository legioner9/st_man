...
  
 ...
 ttyname (3)   ttyname  (3)   ( Solaris man: Библиотечные вызовы )   ttyname  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  ttyname  (3)   ( Русские man: Библиотечные вызовы )   ttyname  (3)   ( Linux man: Библиотечные вызовы )   ttyname  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
