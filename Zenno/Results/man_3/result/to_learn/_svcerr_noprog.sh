...
  
 ...
 svcerr_noprog (3)   svcerr_noprog  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  svcerr_noprog  (3)   ( Русские man: Библиотечные вызовы )   svcerr_noprog  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
