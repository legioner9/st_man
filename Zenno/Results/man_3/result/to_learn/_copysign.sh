...
  
 ...
 copysign (3)   copysign  (3)   ( Solaris man: Библиотечные вызовы )   copysign  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  copysign  (3)   ( Русские man: Библиотечные вызовы )   copysign  (3)   ( Linux man: Библиотечные вызовы )   copysign  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
