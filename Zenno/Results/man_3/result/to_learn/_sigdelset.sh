...
  
 ...
 sigdelset (3)   sigdelset  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  sigdelset  (3)   ( Русские man: Библиотечные вызовы )   sigdelset  (3)   ( Linux man: Библиотечные вызовы )   sigdelset  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
