...
  
 ...
 fileno (3)   fileno  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  fileno  (3)   ( Русские man: Библиотечные вызовы )   fileno  (3)   ( Linux man: Библиотечные вызовы )   fileno  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
