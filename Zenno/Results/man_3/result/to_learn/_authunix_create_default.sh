...
  
 ...
 authunix_create_default (3)   authunix_create_default  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  authunix_create_default  (3)   ( Русские man: Библиотечные вызовы )   authunix_create_default  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
