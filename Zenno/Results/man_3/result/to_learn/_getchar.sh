...
  
 ...
 getchar (3)   getchar  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  getchar  (3)   ( Русские man: Библиотечные вызовы )   getchar  (3)   ( Linux man: Библиотечные вызовы )   getchar  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
