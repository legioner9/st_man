...
  
 ...
 tdelete (3)   tdelete  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  tdelete  (3)   ( Русские man: Библиотечные вызовы )   tdelete  (3)   ( Linux man: Библиотечные вызовы )   tdelete  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
