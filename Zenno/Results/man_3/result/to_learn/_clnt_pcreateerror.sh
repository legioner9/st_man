...
  
 ...
 clnt_pcreateerror (3)   clnt_pcreateerror  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  clnt_pcreateerror  (3)   ( Русские man: Библиотечные вызовы )   clnt_pcreateerror  (3)   ( Linux man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
