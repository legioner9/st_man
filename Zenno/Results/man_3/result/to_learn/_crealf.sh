...
  
 ...
 crealf (3)   crealf  (3)   ( FreeBSD man: Библиотечные вызовы ) >>  crealf  (3)   ( Русские man: Библиотечные вызовы )   crealf  (3)   ( Linux man: Библиотечные вызовы )   crealf  (3)   ( POSIX man: Библиотечные вызовы ) 
   
 НАЗВАНИЕ 
