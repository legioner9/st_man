...
  
 ...
 pam_unix (5)   pam_unix  (5)   ( Solaris man: Форматы файлов ) >>  pam_unix  (5)   ( Русские man: Форматы файлов )   pam_unix  (5)   ( Linux man: Форматы файлов )   pam_unix  (8)   ( FreeBSD man: Команды системного администрирования )   pam_unix  (8)   ( Linux man: Команды системного администрирования ) 
