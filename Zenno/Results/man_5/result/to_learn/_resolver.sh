...
  
 ...
 resolver (5)   resolver  (3)   ( Solaris man: Библиотечные вызовы )   resolver  (3)   ( FreeBSD man: Библиотечные вызовы )   resolver  (3)   ( Русские man: Библиотечные вызовы )   resolver  (3)   ( Linux man: Библиотечные вызовы )   resolver  (5)   ( FreeBSD man: Форматы файлов ) >>  resolver  (5)   ( Русские man: Форматы файлов )   resolver  (5)   ( Linux man: Форматы файлов ) Ключ  resolver  обнаружен в базе ключевых слов. 
