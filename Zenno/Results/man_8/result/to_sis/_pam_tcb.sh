...
  
 ...
 pam_tcb (8)   pam_tcb  (5)   ( Русские man: Форматы файлов )   pam_tcb  (5)   ( Linux man: Форматы файлов ) >>  pam_tcb  (8)   ( Русские man: Команды системного администрирования )   pam_tcb  (8)   ( Linux man: Команды системного администрирования ) 
