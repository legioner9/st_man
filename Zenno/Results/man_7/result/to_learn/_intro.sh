...
Этот раздел описывает соглашения, протоколы, стандартные наборы символов,
план файловой системы и прочее.
   
 АВТОРЫ 
