...
branch on another:  git-merge[1]  and
 git-cherry-pick[1] . 
...
you will need to cherry-pick it (using  git-cherry-pick[1] )
...
merging anything upstream into anything downstream on a regular basis — is frowned upon: 
...
emails, you should use topic branches as usual (see above).  Then use
 git-format-patch[1]  to generate the corresponding emails
