...
history.  (See "History simplification" in  git-log[1] 
...
(e.g.  commit1..commit2  or  commit2 ^commit1 ), only
...
(See "History simplification" in  git-log[1]  for a more
